# DeepAgents - Current State Document
...
**GitHub:** `akarelin/CRAP/DeepAgents/`
...
**Location:** `/deepagents-cli/deepagents/`
...
- `deepagents ask` - Ask a question
- `deepagents next` - What's next workflow
- `deepagents close` - Close session workflow
- `deepagents document` - Document changes workflow
- `deepagents push` - Git push with changelog verification
- `deepagents daemon` - Run as daemon
- `deepagents version` - Show version
- `deepagents diag` - Diagnostics
- `deepagents feedback` - Submit user feedback
...
**Location:** `/deepagents-cli/deepagents/middleware/`
...
**Location:** `/deepagents-cli/deepagents/tools/`
...
**Location:** `/deepagents-cli/deepagents/workflows/`
...
**Location:** `/deepagents-cli/deployment/gcp/`
...
**Location:** `/deepagents-cli/deployment/server-five/`
...
**Location:** `/deepagents-cli/deployment/langchain-cloud/`
...
- `DEEPAGENTS_DATA_SYNC.md` - Data sync architecture
- `LANGCHAIN_CLOUD_DEPLOYMENT.md` - Cloud deployment guide
- `DEEPAGENTS_TEST_CASES.md` - 10 test cases
...
**Location:** `/deepagents-cli/deepagents/prompts/`
...
User expects to use DeepAgents and encounter issues. Next Manus should be ready to debug.
...
**Repository:** akarelin/CRAP/DeepAgents/
